...
$string['item_e2r'] = '2nd level reply';
$string['identifier_e2r'] = '{$a} 2<sup>nd</sup> level reply';
$string['identifier_e2r_plural'] = '{$a} 2<sup>nd</sup> level replies';
$string['item_e3r'] = '3rd level reply';
$string['identifier_e3r'] = '{$a} 3<sup>rd</sup> level reply';
$string['identifier_e3r_plural'] = '{$a} 3<sup>rd</sup> level replies';
$string['item_e4r'] = '4th level reply';
$string['identifier_e4r'] = '{$a} 4<sup>th</sup> level reply';
$string['identifier_e4r_plural'] = '{$a} 4<sup>th</sup> level replies';
